...
API_ID = int(environ.get("API_ID", "21386525"))
API_HASH = environ.get("API_HASH", "5da3555d9ba45c08b911b918ce7c04bc")
BOT_TOKEN = environ.get("BOT_TOKEN", "8388840881:AAHj518ty1wg-RDkKfJJbyQ8yihtFtfcRGg")

OWNER = int(environ.get("OWNER", "6053889491"))
CREDIT = environ.get("CREDIT", "KUMAWAT TO HELP❤️")
